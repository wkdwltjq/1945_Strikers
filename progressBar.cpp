...
HRESULT progressBar::init(float x, float y, int width, int height)
{
	...
	_progressBarTop = IMAGEMANAGER->addImage("frontBar", "hpBarTop.bmp", width, height, true, false, RGB(255, 0, 255));
	_progressBarBottom = IMAGEMANAGER->addImage("backBar", "hpBarBottom.bmp", width, height, true, false, RGB(255, 0, 255));
