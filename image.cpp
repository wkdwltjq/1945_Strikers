...
HRESULT image::init(const char * fileName, int width, int height, BOOL trans, BOOL rotate, COLORREF transColor)
{
...
HRESULT image::init(const char * fileName, float x, float y, int width, int height, int frameX, int frameY, BOOL trans, BOOL rotate, COLORREF transColor)
{
	//이미지 정보가 혹시나 남아있다면 해제해라
	if (_imageInfo != NULL) release();
...
HRESULT image::init(const char * fileName, int width, int height, int frameX, int frameY, BOOL trans, BOOL rotate, COLORREF transColor)
{
	//이미지 정보가 혹시나 남아있다면 해제해라
	if (_imageInfo != NULL) release();
